...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/epic-ai-legion.git`
...
- **Retrieval** — Hybrid search (BM25 + dense semantic + Reciprocal Rank Fusion)
...
Use [GitHub Issues](https://github.com/protectnil/epic-ai-legion/issues). Include:
