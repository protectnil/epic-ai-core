 ...
 * TEST STUB ONLY — not for production use.
 * All search methods (dense, sparse, BM25) use substring matching, not vector similarity.
 * This adapter exists for unit tests and development. For real retrieval, use QdrantAdapter
 * with a configured embedding model.
